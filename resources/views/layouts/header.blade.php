            ...
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container">
                  <a class="navbar-brand" href="/">
                    <img src="{{ asset('images/logo.png') }}" width="160" alt="logo">
                  </a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <div class="row mx-3 justify-content-center align-items-center g-2">
                        <div class="col d-flex USERACTIVE d-none">
                            <div class="imguser">
                                <img src="{{ asset('images/user3.png') }}" class="rounded-circle imguser" alt="user">
                                <div class="activepoint"></div>
                            </div>
                        </div>
                    </div>
                    
                    <div class="align-items-center mx-2 w-50 d-flex">
                        <form method="POST" action='search' class="input-group">
                        @csrf
                            <div class="input-group">
                                @if(isset($term))
                                <input type="text" name="Searchterm" value="{{$term}}" class="form-control" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                @else
                                <input type="text" name="Searchterm" class="form-control" placeholder="Recherche par fichier, code, date, mots clé" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                @endif
                    ...
                    <span class="navbar-text">
                        <div class="align-items-center flex-wrap d-flex">
                            <!--<svg class="mx-3" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 50 50">
                            ...
                            <img src="{{ asset('images/user.png') }}" class="mx-auto d-block rounded-circle" width="35" alt="user">

                            <div class="dropdown mx-2">
                                <div class="btn-group dropdown-center">
                                    <p type="button" class="m-0 fs-6">{{ Auth::user()->name }}</p>
